...
platformlist = [(0, 0), (300, 20), (760, 0),
                ...
                (3400, 20), (3600, 0),
                (4500, 0), (4800, 120), (5200, 240), (5400, 260), (5600, 240), (5800, 250), (6000, 300)]
enemylist = [0]
holex = 3500
introx = 2000
homex = 8000
...
def setup():
    size(1360, 700)
    global deathlist, deathimage, house, backgroundimage, herolist, hero1, enemyimagelist
    ...
    herolist = [hero1, hero2, hero3, hero4, hero5, hero6, hero7, hero8, hero9, hero10,
                hero11, hero12, hero13, hero14, hero15, hero16, hero17, hero18, hero19,
                hero20, hero21, hero22, hero23, hero24, hero25, hero26, hero27, hero28]
    heroimage = hero1
    ...
    enemyimagelist = [enemy1, enemy2, enemy3, enemy4, enemy5, enemy6, enemy7, enemy8]
    enemyimage = enemy1
...
def draw():
    ...
    fill(80, 92, 124)
    image(herolist[int(counter)], playerx, playery-collisiony, playerw, playerh)
    ...
    if not(playery - collisiony == enemyy-1 and
           ...
           playerx - playerw < enemyx):
            ...
            holex -= sidescrol
            homex -= sidescrol
            if keys_pressed[32] and death == False:
                isJump = True
            if keys_pressed[65] and death == False:
                playerx -= vel
            if keys_pressed[68] and death == False:
                playerx += vel
            enemycounter +=.1
            if enemycounter >= 8:
                enemycounter = 1
...
#                 (4500, 0), (4700, 120), (5100, 240)]
    ...
    if (playerx >= platx - 100 and playerx <= platx + 100 and
        ...
        #plat2
    elif (playerx >= platx - playerh + 300 and playerx <= platx + playerh + 300 and 
          playery - collisiony < platy-1-20 or
          playerx >= platx - playerh + 300 and playerx <= platx + playerh + 300 
          and playery - collisiony < platy - playerw - 20 and isJump or isJump):
          collisiony = 320
    ...
    if( playerx <= trianglex - 1400 and playery - collisiony + playerh>= triangley - 50 or playerx >= trianglex and playery - collisiony + playerh <= triangley - 50):
        death = True
    
    print(trianglex, playerx, triangley + playerh - 1 - 50, playery - collisiony)
    fill(80,92,124)
    ...
    if(playerx >= platx + 5000 and playerx <= platx + playerw + 6400 and 
        playery - collisiony < platy - 1 or 
        playerx >= platx - playerw + 5000 and playerx <= platx + playerw + 6400
        and playery - collisiony < platy - playerh and isJump):
            death = True
